            ...
            <div className="md:w-1/2 space-y-4 md:pr-5">
              ...
              <div className="pt-4 border-t border-gray-700">
                ...
                <p className="text-xs text-gray-500 mb-3">
                  ...
                  <a
                    href="https://github.com/arpanghosh8453/skydra#how-to-obtain-your-own-dji-developer-api-key"
                    target="_blank"
              ...
              <div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                  ...
                  <div className="mt-2 grid grid-cols-3 gap-2">
                    <a
                      href="https://github.com/arpanghosh8453/skydra/blob/main/docs/manual.md"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href="https://github.com/arpanghosh8453/skydra/issues/new/choose"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href="https://github.com/arpanghosh8453/skydra/discussions"
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className="pt-4 border-t border-gray-700">
                <p className="text-xs text-gray-500 flex items-center gap-2 flex-wrap">
                  ...
                  {updateStatus === 'outdated' && latestVersion && (
                    <a
                      href="https://github.com/arpanghosh8453/skydra/releases/latest"
                      target="_blank"
                      rel="noopener noreferrer"
